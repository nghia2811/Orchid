...
public class RecyclerViewAdapterLamdep extends RecyclerView.Adapter<RecyclerViewAdapterLamdep.MyViewHolder> {
    private Context mContext ;
    private List<Category2> mData ;

    public RecyclerViewAdapterLamdep(Context mContext, List<Category2> mData) {
