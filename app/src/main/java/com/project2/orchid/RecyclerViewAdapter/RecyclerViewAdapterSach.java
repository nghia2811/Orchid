...
public class RecyclerViewAdapterSach extends RecyclerView.Adapter<RecyclerViewAdapterSach.MyViewHolder> {
    private Context mContext ;
    private List<Category2> mData ;

    public RecyclerViewAdapterSach(Context mContext, List<Category2> mData) {
