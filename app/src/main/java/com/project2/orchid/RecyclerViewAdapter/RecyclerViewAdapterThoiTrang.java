...
public class RecyclerViewAdapterThoiTrang extends RecyclerView.Adapter<RecyclerViewAdapterThoiTrang.MyViewHolder> {
    private Context mContext ;
    private List<Category2> mData ;

    public RecyclerViewAdapterThoiTrang(Context mContext, List<Category2> mData) {
